...
import { resetPasswordWithRecoveryAction } from "@/domain/auth/actions";
...
export function ResetPasswordForm() {
  const [state, formAction, isPending] = useActionState(resetPasswordWithRecoveryAction, initialState);
