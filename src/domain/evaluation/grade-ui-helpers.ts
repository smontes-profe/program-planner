...
import { formatAdjustedGradeValue, parseAdjustedGradeValue } from "./grade-values";
...
/** Parsea una nota ajustada entera o una situación especial. */
...
export { formatAdjustedGradeValue };
