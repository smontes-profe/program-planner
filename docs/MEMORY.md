...
- **Regla de cálculo PRI/PMI:** Para RA mejorada, si no hay override manual, aplica la nota PRI/PMI más reciente por fecha. Si existe override manual, manda siempre el valor manual y deja de recalcular.
