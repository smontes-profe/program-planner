...
- [P1][x] Programaciones: Ya se pueden realizar copias de programaciones. Habrái que hacer que las copias sean forzadas a privadas y no se puedan hacer públicas. Y que aparezca la etiqueta de "clon", como pasa con los  currículos.
